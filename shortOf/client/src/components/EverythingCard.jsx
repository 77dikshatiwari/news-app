      ...
      <div className="everything-card flex flex-wrap p-5 gap-1 mb-1">
        ...
        <div className="info">
          <div className="source-info flex items-center gap-2">
            ...
            >
              {props.source?.substring(0, 70) || "Unknown Source"}
            </a>
          </div>
          <div className="origin flex flex-col">
            ...
            ({props.publishedAt || "Unknown Date"})
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex lg:flex-row">
        ...
        <div className="border rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div className="mb-8">
            ...
            <p className="text-gray-700 text-base">{props.cardDescription || "Card Description"}</p>
          </div>
          <div className="flex items-center">
            ...
            <div className="text-sm">
              <p className="text-gray-900 leading-none">{props.authorName || "Author Name"}</p>
              <p className="text-gray-600">{props.publishedDate || "Publish Date"}</p>
            </div>
          </div>
        </div>
      </div>
