...
//     countries.push(obj);
// })
let countries = twoLetterISO.map((countryCode) => {
    const countryName = isoCountries[countryCode] || countryCode;
    return {
      iso_2_alpha: countryCode,
      png: `https://flagcdn.com/24x18/${countryCode}.png`,
